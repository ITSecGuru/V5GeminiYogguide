 ...
 * --------------------------------------------------------------
 * This file serves as the Single Source of Truth for all yoga steps, asanas, and kriyas.
 * The Master Playlist (routines.js) maps over these keys to dynamically build the UI.
 * * SCHEMA FIELD DICTIONARY:
 * @field names (Object)    - Contains 'devanagari' (Hindi), 'roman' (Transliteration), and 'english' (Translation).
 * @field category (String) - Used for grouping/analytics (e.g., "Warm Up", "Kriya", "Pranayama", "Asana").
 * @field type (String)     - Execution rule: "time" (uses duration), "reps" (uses reps * timePerRep), or "sequence".
 * @field duration (Number) - Total time in seconds for the step (used ONLY if type === "time").
 * @field reps (Number)     - Total repetitions (used ONLY if type === "reps").
 * @field timePerRep (Num)  - Seconds per single repetition (defaults to 5s if null).
 ...
 * @field videoUrl (String) - URL for mp4 video. If populated, replaces the image thumbnail with a video player.
...
export const stepDatabase = {
  ...
  "trikonasana-kriya": { 
    ...
    category: "Kriya",
    type: "reps", duration: null, reps: 16, timePerRep: null, prepTime: 5, hasSides: true, breathPattern: "", benefits: "",
    caution: "", audioUrl: "", videoUrl: "", pictureUrl: "" 
  },
  "konasana-kriya": { 
  ...
  "agnisar-kriya": { 
    ...
    category: "Kriya",
    type: "reps", duration: null, reps: 16, timePerRep: null, prepTime: 5, hasSides: false, breathPattern: "", benefits: "",
    caution: "Do on an empty stomach.", audioUrl: "", videoUrl: "", pictureUrl: "" 
  },

  // --- SPECIALTY SEQUENCES & DRILLS ---
  "surya-namaskar": { 
  ...
  "uttanapadasana": { 
    ...
    category: "Asana",
    type: "time", duration: 60, reps: null, timePerRep: null, prepTime: 5, hasSides: false, breathPattern: "", benefits: "",
    caution: "Support lower back if needed.", audioUrl: "", videoUrl: "", pictureUrl: "" 
  },
  "naukasana": { 
  ...
  "leg-knee-placeholder-18": {
    ...
    category: "Physio",
    type: "reps", duration: null, reps: 12, timePerRep: 5, prepTime: 5, hasSides: true,
    description: "Repeat 12 times on each side with 5 seconds per rep.",
    breathPattern: "Press the leg downward with control, then release slowly before switching sides.", benefits: "Improves leg strength and controlled downward pressure through the limb.",
    caution: "Use a stable stool and keep the movement pain-free.", audioUrl: "", videoUrl: "", pictureUrl: "/assets/images/leg-on-stool-press-down.jpg"
  },
  "leg-knee-placeholder-19": {
    names: { devanagari: "आगे और पीछे चलना", roman: "Forward and Reverse Walk", english: "Forward and Reverse Walk" },
    category: "Physio",
