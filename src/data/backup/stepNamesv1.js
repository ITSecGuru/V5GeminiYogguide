...
export const stepDatabase = {
  ...
  "yogic-jogging-position-1": {
    ...
    hasSides: false,
    breathPattern: "",
    description: "Do not hyperextend the knees.",
    caution: "",
    benefits: "",
    audioUrl: "",
    videoUrl: "",
  ...
  "yogic-jogging-position-4": {
    ...
    hasSides: false,
    breathPattern: "",
    description: "Coordinate breathing with the leg movement.",
    caution: "",
    benefits: "",
    audioUrl: "",
    videoUrl: "",
  ...
  "hasta-sanchalan-kriya": {
    ...
    hasSides: false,
    breathPattern: "",
    description: "Avoid jerky shoulder movements.",
    caution: "",
    benefits: "",
    audioUrl: "",
    videoUrl: "",
  ...
  "agnisar-kriya": {
    ...
    hasSides: false,
    breathPattern: "",
    description: "Do on an empty stomach.",
    caution: "",
    benefits: "",
    audioUrl: "",
    videoUrl: "",
  ...
  "surya-namaskar": {
    ...
    prepTime: 5,
    hasSides: false,
    breathPattern: "Inhale when lifting, exhale when folding — move with your breath.",
    description: "Synchronize breath with movement. Avoid if you have high blood pressure.",
    caution: "",
    benefits: "",
    audioUrl: "",
    videoUrl: "",
  ...
  "bhastrika-pranayama": {
    ...
    hasSides: false,
    breathPattern: "",
    description: "Avoid if you have high blood pressure or heart conditions.",
    caution: "",
    benefits: "",
    audioUrl: "",
    videoUrl: "",
  ...
  "kapal-bhati": {
    ...
    description: "Avoid for 6–12 months after surgery. Hypertension users should practice gently.",
    caution: "",
    benefits: "",
    audioUrl: "",
    videoUrl: "",
  ...
  "anulom-vilom": {
    ...
    prepTime: 5,
    hasSides: false,
    breathPattern: "Inhale through one nostril, exhale through the other. Alternate slowly and evenly.",
    description: "",
    caution: "",
    benefits: "",
    audioUrl: "",
  ...
  "bhramari": {
    ...
    prepTime: 5,
    hasSides: false,
    breathPattern: "Inhale deeply, close the ears with the fingers, hum gently on exhale.",
    description: "",
    caution: "",
    benefits: "",
    audioUrl: "",
  ...
  "uttanapadasana": {
    ...
    hasSides: false,
    breathPattern: "",
    description: "Support lower back if needed.",
    caution: "",
    benefits: "",
    audioUrl: "",
    videoUrl: "",
